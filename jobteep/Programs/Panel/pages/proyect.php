<div class = "large-10 large-offset-1 columns">
	<div class = "row">
		<ul class="breadcrumbs">
		  ...
		  <li class="current"><a href="#">Proyectos</a></li>
		</ul>
	</div>
	<div class = "row">
		<div class = "large-12 columns"><a href="?program=panel&menu=new_proyect" class="button">Nuevo Proyecto</a></div>
	</div>
</div>
<div class = "row" data-equalizer>
	<div class = "large-10 large-offset-1 columns">
		...
		foreach ($proyect as $k => $v) {
			...
			echo '
				<a href="?program=panel&menu=new_proyect&id='.$v->getId().'">
					<div class = "medium-4 columns">
						...
						echo '</dd>';*/
							echo '</dl>
							<a href="?program=panel&menu=proyectimg&idproy='.$v->getId().'" class="button expand">IMAGENES</a>
