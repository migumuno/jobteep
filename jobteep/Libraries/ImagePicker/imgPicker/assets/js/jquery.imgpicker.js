;(function($, window, document, undefined) {
	...
	defaults = {
        ...
        // Flash swf url
        swf: 'Libraries/ImagePicker/imgPicker/assets/webcam.swf',
	...
	Plugin.prototype = {
		...
		load: function() {
			...
			$.ajax({
				...
				dataType: 'json',
				data: {action: 'load', key: this.options.key, data: this.options.data},
		...
		crop: function(image) {
			...
			var self = this, 
			imagePreview = this.options.url + '?action=preview&file=' + image.name + '&width=400',
			rotation = 0,
	        coords,
