...
class ImgPicker
{
	...
	protected $error_messages = array(
        ...
        'max_file_size' => 'El archivo es demasiado grande: 1 MB',
        'min_file_size' => 'File is too small',
        'accept_file_types' => 'El tipo de archivo no está permitido',
	...
	{	
        ...
        if (isset($this->options['min_file_size']) && $file->size < $this->options['min_file_size']) {
